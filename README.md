...
```bash
git clone [https://github.com/azaliyasli/IIoT-Based-Automated-Production-Counter.git](https://github.com/azaliyasli/IIoT-Based-Automated-Production-Counter.git)
cd visiontrack-iiot
```
